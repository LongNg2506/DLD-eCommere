CLAUDE.md
Tổng quan dự án
Đây là template ASP.NET Core .NET 9.0 cho dự án web/app quản trị hoặc e-commerce, sử dụng C#, SQL Server, Entity Framework Core, ASP.NET Core MVC hoặc Web API, Razor View nếu làm MVC, và kiến trúc theo pattern nhiều feature.
...
Với .NET 9.0, ưu tiên EF Core 9.x
